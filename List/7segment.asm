...
; 0000 002C 
; 0000 002D DDRB=0b11111111;
	OUT  0x17,R30
; 0000 002E PORTB=0b11111110;
	LDI  R30,LOW(254)
	OUT  0x18,R30
; 0000 002F 
...
_0x3:
; 0000 0087       {
; 0000 0088       PORTA=0b10000110;
	LDI  R30,LOW(134)
	RCALL SUBOPT_0x0
; 0000 0089       delay_ms(a);
; 0000 008A       PORTA=0b11011011;
	LDI  R30,LOW(219)
	RCALL SUBOPT_0x0
; 0000 008B       delay_ms(a);
; 0000 008C       PORTA=0b11001111;
	LDI  R30,LOW(207)
	RCALL SUBOPT_0x0
; 0000 008D       delay_ms(a);
; 0000 008E 
; 0000 008F       PORTA=0b11100110;
	LDI  R30,LOW(230)
	RCALL SUBOPT_0x0
; 0000 0090       delay_ms(a);
; 0000 0091 
; 0000 0092       PORTA=0b11101101;
	LDI  R30,LOW(237)
	RCALL SUBOPT_0x0
; 0000 0093       delay_ms(a);
; 0000 0094 
; 0000 0095       PORTA=0b11111101;
	LDI  R30,LOW(253)
	RCALL SUBOPT_0x0
; 0000 0096       delay_ms(a);
; 0000 0097 
; 0000 0098       PORTA=0b10000111;
	LDI  R30,LOW(135)
	RCALL SUBOPT_0x0
; 0000 0099       delay_ms(a);
; 0000 009A 
; 0000 009B       PORTA=0b11111111;
	LDI  R30,LOW(255)
	RCALL SUBOPT_0x0
; 0000 009C       delay_ms(a);
; 0000 009D 
; 0000 009E       PORTA=0b11101111;
	LDI  R30,LOW(239)
	RCALL SUBOPT_0x0
; 0000 009F       delay_ms(a);
; 0000 00A0 
; 0000 00A1       PORTA=0b10111111;
	LDI  R30,LOW(191)
	RCALL SUBOPT_0x0
; 0000 00A2       delay_ms(a);
; 0000 00A3 
; 0000 00A4 
; 0000 00A5 
; 0000 00A6 
