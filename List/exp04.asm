...
_0x3:
; 0000 0085       {
; 0000 0086       PORTB=0b11111110;
	LDI  R30,LOW(254)
	OUT  0x18,R30
; 0000 0087       PORTA=0b00111111;
	LDI  R30,LOW(63)
	RCALL SUBOPT_0x0
; 0000 0088 
; 0000 0089       delay_ms(20);
; 0000 008A       PORTB=0b11111101;
	LDI  R30,LOW(253)
	OUT  0x18,R30
; 0000 008B       PORTA=0b01101111;
	LDI  R30,LOW(111)
	RCALL SUBOPT_0x0
; 0000 008C       delay_ms(20);
; 0000 008D 
; 0000 008E       PORTB=0b01111011;
	LDI  R30,LOW(123)
	OUT  0x18,R30
; 0000 008F       PORTA=0b01011011;
	LDI  R30,LOW(91)
	RCALL SUBOPT_0x0
