...
_0x3:
; 0000 0085       {
; 0000 0086       PORTA=0b00000001;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x0
; 0000 0087       delay_ms(1000);
; 0000 0088       PORTA=0b00000010;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x0
; 0000 0089       delay_ms(1000);
; 0000 008A       PORTA=0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x0
; 0000 008B       delay_ms(1000);
; 0000 008C       PORTA=0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x0
; 0000 008D       delay_ms(1000);
; 0000 008E       PORTA=0b00010000;
	LDI  R30,LOW(16)
	RCALL SUBOPT_0x0
; 0000 008F       delay_ms(1000);
; 0000 0090       PORTA=0b00100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 0091       delay_ms(1000);
; 0000 0092       PORTA=0b01000000;
	LDI  R30,LOW(64)
	RCALL SUBOPT_0x0
; 0000 0093       delay_ms(1000);
; 0000 0094       PORTA=0b10000000;
	LDI  R30,LOW(128)
	RCALL SUBOPT_0x0
